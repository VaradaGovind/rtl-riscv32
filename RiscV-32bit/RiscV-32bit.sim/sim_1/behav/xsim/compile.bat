...
REM
REM Generated by Vivado on Thu Mar 26 17:39:43 +0530 2026
...
echo "xvlog --incr --relax -prj nexys4_top_vlog.prj"
call xvlog  --incr --relax -prj nexys4_top_vlog.prj -log xvlog.log
